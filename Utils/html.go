...
func WriteHtmlHeader(w http.ResponseWriter, name string, refresh, plot, maps bool) {
	...
	w.Write([]byte("<meta name=\"og:url\" content=\"http://elections.argusdusty.com\"/>"))
	...
	if plot {
		w.Write([]byte(`<script src="https://cdnjs.cloudflare.com/ajax/libs/plotly.js/1.34.0/plotly.min.js" integrity="sha512-iOyXdAl/XmlncnVK5YS45woTD/ZufF4hIL7ZPKwQsQUM7sE+VC9Ihjx/b7uPQjbpAl9MBU98pHrpi7nobOrVnQ==" crossorigin="anonymous"></script>
...
<script src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha512-+NqPlbbtM1QqiK8ZAo4Yrj2c4lNQoGv8P79DPtKzj++l5jnN39rHA/xsqn8zE9l0uSoxaCdrOgFs6yjyfbBxSg==" crossorigin="anonymous"></script>`))
	...
	if maps {
		w.Write([]byte(`<link rel="stylesheet" href="https://unpkg.com/leaflet@1.3.1/dist/leaflet.css" integrity="sha256-iYUgmrapfDGvBrePJPrMWQZDcObdAcStKBpjP3Az+3s=" crossorigin="anonymous">
